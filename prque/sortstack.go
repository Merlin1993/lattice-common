...
func newSortStack(setIndex SetIndexCallback) *sortStack {
	result := new(sortStack)
...
func (s *sortStack) Push(data interface{}) {
...
func (s *sortStack) Pop() (res interface{}) {
	s.size--
	s.offset--
	if s.offset < 0 {
...
func (s *sortStack) Reset() {
	*s = *newSortStack(s.setIndex)
}
